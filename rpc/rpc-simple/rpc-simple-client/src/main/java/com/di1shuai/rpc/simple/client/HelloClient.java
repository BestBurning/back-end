package com.di1shuai.rpc.simple.client;

import com.di1shuai.rpc.client.RpcProxy;
import com.di1shuai.rpc.registry.ServiceDiscover;
...
@Configuration
@ComponentScan(value = "com.di1shuai.rpc.simple.client")
